...
<head>
  ...
  <style>
    *{box-sizing:border-box}
    ...
    .header-bottom{display:grid;gap:.46rem;margin-top:.2rem;color:rgba(255,255,255,.82)}
    .legal-nav a,.support-note a,.copyright-note{padding-left:0;padding-right:0;font-size:.88rem}
    .support-note,.copyright-note{margin:0;line-height:1.35}.support-note a{display:block;padding-top:.2rem;padding-bottom:.2rem}
  ...
  <div class="header-inner">
    ...
    <div class="nav-cartouche">
      ...
      <nav class="secondary-nav" aria-label="Singular tools and resources">
        ...
        <a href="https://www.singular.uni-kl.de:8003/" target="_blank" rel="noopener">Try Online</a>
    ...
    <div class="header-bottom">
      ...
      <p class="support-note"><a href="https://www.computeralgebra.de/sfb/">Supported by SFB-TRR 195</a></p>
